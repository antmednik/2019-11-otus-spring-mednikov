...
import ru.otus.homework.data.repository.BookRepository;
import ru.otus.homework.data.repository.GenreRepository;
...
public class BookStorageServiceImpl implements BookStorageService {
    ...
    public boolean deleteBookById(UUID bookId){
        return bookRepository.removeById(bookId) == 1L;
    }
